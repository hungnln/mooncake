        ...
        try {
            ...
            if (user != null) {
                if (user.getRoleId().getId() == StaticVariable.getAdminRole()) {
                    ...
                    request.setAttribute("msgStatus", "You can't use this function");
                }
            }
            session.removeAttribute("cart");
            request.setAttribute("msgDelete", "Delete cart success");
        } catch (Exception e) {
            log("DeleteCartServlet_Exception at: " + e.getMessage());
        } finally {
